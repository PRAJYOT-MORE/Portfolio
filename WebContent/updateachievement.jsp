...
<body style="background-color: #C5DFF8">
	...
	<h1 class="card-title text-center" style="color: #7895CB;">Update Achievements</h1>
	
	<br><br>
	
	<form style="text-align: left; display:inline; padding : 20px; padding-left: 130px;" action="showachievement.jsp" method="post">
		...
		<div class="row justify-content-center">
			<div class="col-md-5">
				<div style="background-color: #7895CB;" class="card">
					<h2 class="card-title text-center" style="color: #EEEEEE;">Update Year</h2>
					<div style="color:"grey";" class="card-body py-md-4">
						<form _lpchecked="1" action = "AchievementController" method = "post">                
	...
	<div style="margin-bottom:20px;" class="container">
		<div class="row justify-content-center">
			<div class="col-md-5">
				<div style="background-color: #7895CB;" class="card">
					<h2 class="card-title text-center" style="color: #EEEEEE;">Update Title</h2>
					<div style="color:"grey";" class="card-body py-md-4">
						<form _lpchecked="1" action = "AchievementController" method = "post">                
				            <div class="form-group">
