...
<body style="background-color: #C5DFF8">
	...
	<form style="text-align: left; display:inline; padding : 20px; padding-left: 130px;" action="showproject.jsp" method="post">
		...
		<div class="row justify-content-center">
			<div class="col-md-5">
	   			<div style="background-color: #7895CB;" class="card">
	     			<h2 class="card-title text-center" style="color: #EEEEEE;">Add new Project</h2>
	      			<div style="color:"grey";" class="card-body py-md-4">
	       				<form enctype = "multipart/form-data" _lpchecked="1" action = "ProjectController" method = "post">
	       					<h4>Select File</h4>
